        ...
        $.ajax({
          ...
          success: function(data)
          {
            if (data.status == 'forbidden'){
              ...
              get_department2(data.company_id, data.dept_id);
      ...
      document.addEventListener("DOMContentLoaded", function(event) {
        ...
        table = $('#datatables-reponsive').DataTable({ 
            ...
            "aoColumns": [
              ...
              { "Department": "Department" , "sClass": "text-left" },
              { "Jenis Perangkat": "Jenis Perangkat" , "sClass": "text-left" },
              { "User": "User" , "sClass": "text-left" },
              { "Spesifikasi": "Spesifikasi" , "sClass": "text-left" }
            ],
            "columnDefs": [
              { 
                "targets": [ 0 ],
